  ...
  render() {
    return (
      <Row className={Styles.home}>
        ...
        <Column>
          <Align center>
            <Link to="/lekcja/intro" className="button">Zacznij (za darmo!)</Link>
          </Align>         
        </Column>        
