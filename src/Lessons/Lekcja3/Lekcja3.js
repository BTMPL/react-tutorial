...
export default class Lesson extends React.Component {
  ...
  static getSections = () => {
    return [
      ...
      {
        url: '/lekcja/lekcja3/props',
        title: 'Przekazywanie danych do dziecka - props'
      },      
      {
        url: '/lekcja/lekcja3/prop-types',
        title: 'propTypes i defaultProps'
      },
      {
        url: '/lekcja/lekcja3/listy-komponentow',
        title: 'Listy komponentów'
      },
      {
        url: '/lekcja/lekcja3/wprowadzenie-do-formularzy',
        title: 'Formularze niekontrolowane, referencje'
      }, 
      {
        url: '/lekcja/lekcja3/zdarzenia',
        title: 'Zdarzenia'
      }, 
      {
        url: '/lekcja/lekcja3/stan-komponentu',
        title: 'Stan komponentu'
      },        
      {
        url: '/lekcja/lekcja3/cykl-zycia-komponentu',
        title: 'Cykl życia komponentu',
      },
      {
        url: '/lekcja/lekcja3/przekazywanie-danych-do-rodzica',
  ...
  renderProps = () => {
    return (
      <div>
        <Row>
          <Column>
            <h2>Przekazywanie danych do dziecka</h2>
            <p>
